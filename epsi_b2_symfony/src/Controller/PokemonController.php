...
class PokemonController extends AbstractController
{
    ...
    /**
    * @Route("/pokemon/{type}", name="pokemon_showType", methods={"GET"})
    */
    public function showType($type)
    {
        $pokemonstype = $this->getDoctrine()-> getRepository(Pokemon::class)->findByType($type);
        dump($pokemonstype); exit;

        return $this->render('pokemon/show.html.twig', ['pokedex' => $pokemonstype]);
    }
